...
nvidia-smi
python ../GPT2_Quanti_Init.py $DATASET  --K ${K} --tau ${TEMP} --weight_decay ${WD} --prune --sample \
       ...
       --save_pretrain_path /scratch/gilbreth/wang4538/DGMS/pretrained/GPT2_K${K}_Init
EOT